...
class ModelController():
    ...
    def load_model(self,model_name):
        ...
        if (self.model_name == "Vgg19"):
            path = "./resources/saved_models/final_models/vgg19_1_3_0.97.pt"
        ...
        if(self.model_name == "Densenet"):
            path = "./resources/saved_models/final_models/dense_2_2_0.97.pt"
            self.model = torchvision.models.densenet201()
            self.model.classifier= torch.nn.Linear(in_features=1920, out_features=3)
        if(self.model_name == "Mobilenet"):
            path = "./resources/saved_models/final_models/mobilenetv3_3_7_5500_0.97.pt"
        ...
        if(self.model_name == "Alexnet"):
            path = "./resources/saved_models/final_models/alex_final_16.0000_0.948.pt"
        ...
        if (self.model_name == "Resnet"):
            path = "./resources/saved_models/final_models/ResNet152_11400_5_0.97.pt"
            self.model = torchvision.models.resnet152()
            self.model.fc = torch.nn.Linear(2048, 3)
            
        if (self.model_name == "Rexnet"):
            path = "./resources/saved_models/final_models/rexnet_3_7_7800_0.95.pt"
